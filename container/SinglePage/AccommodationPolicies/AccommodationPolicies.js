...
import AccommodationPoliciesArea, {
  AccommodationPolicieswrapper,
} from "./AccommodationPolicies.style";
import { Element } from "react-scroll";
import CancellationPolicies from "./CancellationPolicies";
import ContractTypes from "./ContractTypes";

const AccommodationPolicies = ({ titleStyle, titleStyleAP, detailstyle }) => {
              ...
              <>
                ...
                <Col span={16}>
                  <Text
                    ...
                    content={apartment.term_and_cond}
                    {...detailstyle}
                  />
                </Col>
              </>
            ...
            {apartment && (
              <>
                ...
                <Col span={16}>
                  <Text
                    style={{ margin: "20px !important" }}
                    content={apartment.deposit_instructions}
                    {...detailstyle}
                  />
                </Col>
              </>
            ...
            {apartment && (
              <>
                <Col span={8}>
                  {" "}
                  <Heading
                    className="cancellation-policy-title"
